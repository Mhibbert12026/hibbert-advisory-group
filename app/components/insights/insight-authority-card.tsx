...
export function InsightAuthorityCard() {
  return (
    <section aria-labelledby="insight-author-heading" className="border-t border-white/10 pt-16">
      <article className="overflow-hidden rounded-2xl border border-amber-500/20 bg-gradient-to-br from-[#152a45]/80 via-[#0f1c30] to-[#0a1424] shadow-xl shadow-black/25">
        <div className="grid gap-0 lg:grid-cols-[280px_1fr]">
          <div className="relative aspect-square lg:aspect-auto lg:min-h-[300px]">
            <Image
          ...
          <div className="flex flex-col justify-center p-8 lg:p-10">
            ...
            <h2 id="insight-author-heading" className="mt-3 text-2xl font-semibold text-white sm:text-3xl">
              {INSIGHT_AUTHOR.name}
            </h2>
